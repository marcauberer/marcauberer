...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.19.6](https://github.com/spicelang/spice/releases/tag/0.19.6), 2 days ago) - Spice Programming Language
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.3.1](https://github.com/mui/mui-x/releases/tag/v7.3.1), 4 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
