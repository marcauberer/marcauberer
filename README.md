...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.8.0-RC3](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.8.0-RC3), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
...
- [chillibits/spice](https://github.com/chillibits/spice) ([0.3.0](https://github.com/chillibits/spice/releases/tag/0.3.0), 2 days ago) - Spice Programming Language
...
- [marcauberer/simple-settings](https://github.com/marcauberer/simple-settings) ([1.3.2](https://github.com/marcauberer/simple-settings/releases/tag/1.3.2), 2 weeks ago) - ⚙️ Simple Settings library for Android
