...
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.0.0-alpha.2](https://github.com/mui/mui-x/releases/tag/v7.0.0-alpha.2), 4 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
- [pygments/pygments](https://github.com/pygments/pygments) ([2.17.2](https://github.com/pygments/pygments/releases/tag/2.17.2), 6 days ago) - Pygments is a generic syntax highlighter written in Python
