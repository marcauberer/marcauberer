...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.27.0-rc.3](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.27.0-rc.3), 2 days ago) - Native Android app using the Apple/Google exposure notification API.
...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.11.1](https://github.com/spicelang/spice/releases/tag/0.11.1), 4 days ago) - Spice Programming Language
- [compose-generator/ccom](https://github.com/compose-generator/ccom) ([1.5.0](https://github.com/compose-generator/ccom/releases/tag/1.5.0), 6 days ago) - ⚙️ Compiler for the CCom (Conditional Comments) language
