...
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.16.1](https://github.com/mui/mui-x/releases/tag/v6.16.1), 2 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
...
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-17.0.2](https://github.com/llvm/llvm-project/releases/tag/llvmorg-17.0.2), 5 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
