...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v1.10.2](https://github.com/goreleaser/goreleaser/releases/tag/v1.10.2), 2 days ago) - Deliver Go binaries as fast and easily as possible
- [spicelang/spice](https://github.com/spicelang/spice) ([0.8.7](https://github.com/spicelang/spice/releases/tag/0.8.7), 2 days ago) - Spice Programming Language
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.24.2-rc.1](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.24.2-rc.1), 3 days ago) - Native Android app using the Apple/Google exposure notification API.
