...
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.18.6](https://github.com/mui/mui-x/releases/tag/v6.18.6), 4 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.5.3](https://github.com/squidfunk/mkdocs-material/releases/tag/9.5.3), 5 days ago) - Documentation that simply works
