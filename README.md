...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.25.0-rc.1-b](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.25.0-rc.1-b), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
- [spicelang/spice](https://github.com/spicelang/spice) ([0.8.8](https://github.com/spicelang/spice/releases/tag/0.8.8), 2 days ago) - Spice Programming Language
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v1.10.2](https://github.com/goreleaser/goreleaser/releases/tag/v1.10.2), 6 days ago) - Deliver Go binaries as fast and easily as possible
