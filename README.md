...
- [compose-generator/ccom](https://github.com/compose-generator/ccom) ([0.8.1](https://github.com/compose-generator/ccom/releases/tag/0.8.1), 6 days ago) - ⚙️ Compiler for the CCom (Conditional Comments) language
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.9.0-RC0](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.9.0-RC0), 6 days ago) - Native Android app using the Apple/Google exposure notification API.
