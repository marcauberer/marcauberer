...
- [aldabil21/react-scheduler](https://github.com/aldabil21/react-scheduler) ([2.9.5](https://github.com/aldabil21/react-scheduler/releases/tag/2.9.5), 4 days ago) - React scheduler component based on Material-UI &amp; date-fns
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-19.1.0-rc4](https://github.com/llvm/llvm-project/releases/tag/llvmorg-19.1.0-rc4), 6 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
