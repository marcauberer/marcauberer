...
- [mikepenz/AboutLibraries](https://github.com/mikepenz/AboutLibraries) ([v8.9.0](https://github.com/mikepenz/AboutLibraries/releases/tag/v8.9.0), 1 day ago) - AboutLibraries is a library to offer some information of libraries.
...
- [marcauberer/compose-number-picker](https://github.com/marcauberer/compose-number-picker) ([1.0.4](https://github.com/marcauberer/compose-number-picker/releases/tag/1.0.4), 4 days ago) - 🔢 Jetpack Compose compatible number picker for Android
