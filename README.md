...
- [pygments/pygments](https://github.com/pygments/pygments) ([2.17.2](https://github.com/pygments/pygments/releases/tag/2.17.2), 1 day ago) - Pygments is a generic syntax highlighter written in Python
...
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.0.0-alpha.1](https://github.com/mui/mui-x/releases/tag/v7.0.0-alpha.1), 5 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
- [spicelang/spice](https://github.com/spicelang/spice) ([0.18.2](https://github.com/spicelang/spice/releases/tag/0.18.2), 6 days ago) - Spice Programming Language
