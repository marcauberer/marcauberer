...
- [pygments/pygments](https://github.com/pygments/pygments) ([2.21.0](https://github.com/pygments/pygments/releases/tag/2.21.0), 1 day ago) - Pygments is a generic syntax highlighter written in Python
- [spicelang/spice](https://github.com/spicelang/spice) ([0.27.1](https://github.com/spicelang/spice/releases/tag/0.27.1), 3 days ago) - Compiler and standard library for the Spice programming language.
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-23.1.0-rc3](https://github.com/llvm/llvm-project/releases/tag/llvmorg-23.1.0-rc3), 6 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
