...
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.4.2](https://github.com/squidfunk/mkdocs-material/releases/tag/9.4.2), 1 day ago) - Documentation that simply works
- [spicelang/spice](https://github.com/spicelang/spice) ([0.17.8](https://github.com/spicelang/spice/releases/tag/0.17.8), 2 days ago) - Spice Programming Language
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.15.0](https://github.com/mui/mui-x/releases/tag/v6.15.0), 4 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
