...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.17.4](https://github.com/spicelang/spice/releases/tag/0.17.4), 1 day ago) - Spice Programming Language
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.13.0](https://github.com/mui/mui-x/releases/tag/v6.13.0), 3 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-17.0.0-rc4](https://github.com/llvm/llvm-project/releases/tag/llvmorg-17.0.0-rc4), 6 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
