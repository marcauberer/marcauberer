...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.16.0-RC6](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.16.0-RC6), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
- [mikepenz/AboutLibraries](https://github.com/mikepenz/AboutLibraries) ([v10.0.0-b07](https://github.com/mikepenz/AboutLibraries/releases/tag/v10.0.0-b07), 1 day ago) - AboutLibraries automatically collects all dependencies and licenses of any gradle project (Kotlin Multi Platform), and provides easy to integrate UI components for Android and Compose-jb environments 
