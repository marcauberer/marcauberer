...
- [spicelang/spice-setup-action](https://github.com/spicelang/spice-setup-action) ([v1.0.25](https://github.com/spicelang/spice-setup-action/releases/tag/v1.0.25), 1 day ago) - GitHub Action to setup Spice 
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-23.1.0-rc2](https://github.com/llvm/llvm-project/releases/tag/llvmorg-23.1.0-rc2), 6 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
