...
- [pygments/pygments](https://github.com/pygments/pygments) ([2.21.0](https://github.com/pygments/pygments/releases/tag/2.21.0), 3 days ago) - Pygments is a generic syntax highlighter written in Python
- [spicelang/spice](https://github.com/spicelang/spice) ([0.27.1](https://github.com/spicelang/spice/releases/tag/0.27.1), 5 days ago) - Compiler and standard library for the Spice programming language.
