...
- [spicelang/spice-setup-action](https://github.com/spicelang/spice-setup-action) ([v1.0.20](https://github.com/spicelang/spice-setup-action/releases/tag/v1.0.20), 2 days ago) - GitHub Action to setup Spice 
- [spicelang/spice](https://github.com/spicelang/spice) ([0.24.3](https://github.com/spicelang/spice/releases/tag/0.24.3), 6 days ago) - Spice Programming Language
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-21.1.8](https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.8), 3 weeks ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
