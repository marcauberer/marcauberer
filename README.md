...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.7.6](https://github.com/spicelang/spice/releases/tag/0.7.6), 3 days ago) - Spice Programming Language
- [mongodb/bson-rust](https://github.com/mongodb/bson-rust) ([v2.2.0-beta](https://github.com/mongodb/bson-rust/releases/tag/v2.2.0-beta), 5 days ago) - Encoding and decoding support for BSON in Rust
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.20.1-rc.0](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.20.1-rc.0), 6 days ago) - Native Android app using the Apple/Google exposure notification API.
