...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.23.0-rc.1](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.23.0-rc.1), 2 days ago) - Native Android app using the Apple/Google exposure notification API.
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v1.8.3](https://github.com/goreleaser/goreleaser/releases/tag/v1.8.3), 4 weeks ago) - Deliver Go binaries as fast and easily as possible
