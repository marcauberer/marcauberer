...
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.5.20](https://github.com/squidfunk/mkdocs-material/releases/tag/9.5.20), 3 days ago) - Documentation that simply works
- [spicelang/spice](https://github.com/spicelang/spice) ([0.19.6](https://github.com/spicelang/spice/releases/tag/0.19.6), 4 days ago) - Spice Programming Language
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.3.1](https://github.com/mui/mui-x/releases/tag/v7.3.1), 6 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-18.1.4](https://github.com/llvm/llvm-project/releases/tag/llvmorg-18.1.4), 2 weeks ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
