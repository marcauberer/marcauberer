...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.17.1](https://github.com/spicelang/spice/releases/tag/0.17.1), 3 days ago) - Spice Programming Language
- [pygments/pygments](https://github.com/pygments/pygments) ([2.16.1](https://github.com/pygments/pygments/releases/tag/2.16.1), 3 days ago) - Pygments is a generic syntax highlighter written in Python
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.11.0](https://github.com/mui/mui-x/releases/tag/v6.11.0), 5 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
