...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.13.1-RC1](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.13.1-RC1), 4 days ago) - Native Android app using the Apple/Google exposure notification API.
- [compose-generator/ccom](https://github.com/compose-generator/ccom) ([1.1.0](https://github.com/compose-generator/ccom/releases/tag/1.1.0), 5 days ago) - ⚙️ Compiler for the CCom (Conditional Comments) language
