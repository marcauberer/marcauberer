...
- [pygments/pygments](https://github.com/pygments/pygments) ([2.17.2](https://github.com/pygments/pygments/releases/tag/2.17.2), 2 days ago) - Pygments is a generic syntax highlighter written in Python
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.4.10](https://github.com/squidfunk/mkdocs-material/releases/tag/9.4.10), 4 days ago) - Documentation that simply works
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.0.0-alpha.1](https://github.com/mui/mui-x/releases/tag/v7.0.0-alpha.1), 6 days ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
