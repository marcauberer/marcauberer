...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.19.0-rc.2](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.19.0-rc.2), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
- [compose-generator/ccom](https://github.com/compose-generator/ccom) ([1.3.0](https://github.com/compose-generator/ccom/releases/tag/1.3.0), 2 days ago) - ⚙️ Compiler for the CCom (Conditional Comments) language
- [skydoves/android-developer-roadmap](https://github.com/skydoves/android-developer-roadmap) ([1.0.3](https://github.com/skydoves/android-developer-roadmap/releases/tag/1.0.3), 3 days ago) - 🗺 Android Developer Roadmap 2022 suggests learning paths to understanding Android development.
