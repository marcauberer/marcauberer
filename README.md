...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.25.0-rc.1-b](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.25.0-rc.1-b), 2 days ago) - Native Android app using the Apple/Google exposure notification API.
- [spicelang/spice](https://github.com/spicelang/spice) ([0.8.8](https://github.com/spicelang/spice/releases/tag/0.8.8), 3 days ago) - Spice Programming Language
