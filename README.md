...
- [mongodb/bson-rust](https://github.com/mongodb/bson-rust) ([v2.3.0](https://github.com/mongodb/bson-rust/releases/tag/v2.3.0), 3 days ago) - Encoding and decoding support for BSON in Rust
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.23.1](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.23.1), 5 days ago) - Native Android app using the Apple/Google exposure notification API.
