...
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-18.1.0-rc1](https://github.com/llvm/llvm-project/releases/tag/llvmorg-18.1.0-rc1), today) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.5.6](https://github.com/squidfunk/mkdocs-material/releases/tag/9.5.6), 2 days ago) - Documentation that simply works
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.0.0-beta.0](https://github.com/mui/mui-x/releases/tag/v7.0.0-beta.0), 4 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
