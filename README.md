...
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-21.1.0-rc3](https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.0-rc3), 1 week ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
- [spicelang/spice](https://github.com/spicelang/spice) ([0.22.3](https://github.com/spicelang/spice/releases/tag/0.22.3), 2 weeks ago) - Spice Programming Language
...
- [compose-generator/ccom](https://github.com/compose-generator/ccom) ([1.6.0](https://github.com/compose-generator/ccom/releases/tag/1.6.0), 7 months ago) - ⚙️ Compiler for the CCom (Conditional Comments) language
