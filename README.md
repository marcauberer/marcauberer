...
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.0.0](https://github.com/mui/mui-x/releases/tag/v7.0.0), 3 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
- [spicelang/spice](https://github.com/spicelang/spice) ([0.19.5](https://github.com/spicelang/spice/releases/tag/0.19.5), 5 days ago) - Spice Programming Language
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-18.1.2](https://github.com/llvm/llvm-project/releases/tag/llvmorg-18.1.2), 5 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
