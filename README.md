...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.13.0-RC0](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.13.0-RC0), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
- [mikepenz/AboutLibraries](https://github.com/mikepenz/AboutLibraries) ([v8.9.4](https://github.com/mikepenz/AboutLibraries/releases/tag/v8.9.4), 2 days ago) - AboutLibraries is a library to offer some information of libraries.
- [dkrivoruchko/ScreenStream](https://github.com/dkrivoruchko/ScreenStream) ([3.8.2](https://github.com/dkrivoruchko/ScreenStream/releases/tag/3.8.2), 6 days ago) - Screen Stream over HTTP mobile app
