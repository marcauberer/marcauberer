...
- [corona-warn-app/cwa-app-android](https://github.com/corona-warn-app/cwa-app-android) ([v2.21.0-rc.2](https://github.com/corona-warn-app/cwa-app-android/releases/tag/v2.21.0-rc.2), 1 day ago) - Native Android app using the Apple/Google exposure notification API.
- [mongodb/bson-rust](https://github.com/mongodb/bson-rust) ([v2.2.0-beta.1](https://github.com/mongodb/bson-rust/releases/tag/v2.2.0-beta.1), 6 days ago) - Encoding and decoding support for BSON in Rust
