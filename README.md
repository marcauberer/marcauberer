...
- [spicelang/spice](https://github.com/spicelang/spice) ([0.19.6](https://github.com/spicelang/spice/releases/tag/0.19.6), 1 day ago) - Spice Programming Language
- [mui/mui-x](https://github.com/mui/mui-x) ([v7.3.1](https://github.com/mui/mui-x/releases/tag/v7.3.1), 3 days ago) - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.5.19](https://github.com/squidfunk/mkdocs-material/releases/tag/9.5.19), 4 days ago) - Documentation that simply works
