...
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.4.4](https://github.com/squidfunk/mkdocs-material/releases/tag/9.4.4), 1 day ago) - Documentation that simply works
- [llvm/llvm-project](https://github.com/llvm/llvm-project) ([llvmorg-17.0.2](https://github.com/llvm/llvm-project/releases/tag/llvmorg-17.0.2), 3 days ago) - The LLVM Project is a collection of modular and reusable compiler and toolchain technologies.
- [mui/mui-x](https://github.com/mui/mui-x) ([v6.16.0](https://github.com/mui/mui-x/releases/tag/v6.16.0), 1 week ago) - MUI X: Build data-rich applications using a growing list of advanced React components.
